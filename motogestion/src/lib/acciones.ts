...
export const DEFAULT_ACCIONES: Record<Role, string[]> = {
  ...
  ADMIN: [
    // 15-sep-2026: la pantalla y la base decían cosas distintas — `_acciones_default()` en SQL SÍ
    // se lo daba a ADMIN (y el trigger de la mig 067 lo habría dejado pasar), pero acá estaba
    // ausente, así que el botón no salía. Decisión del dueño: Sergio sí puede. Se repone acá;
    // la base ya lo tenía, por eso no hubo migración.
